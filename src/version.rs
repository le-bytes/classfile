use crate::error::{ClassReaderError, Result};

/// Versions of the JVM class file format.
#[derive(Debug, PartialEq, Default, strum_macros::Display, Clone)]
#[allow(dead_code)]
...
#[cfg(test)]
mod tests {
    use crate::{error::ClassReaderError, version::ClassFileVersion};
